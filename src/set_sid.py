...
def main():
	juman_ntc_pathlist = glob.glob('/home/sibava/corpus/ntc-train-with-juman/dev/*')
	...
	for juman_path,original_path in zip(juman_ntc_pathlist,original_ntc_pathlist):
		with open(juman_path,'r',encoding='utf-8') as juman,open(original_path,'r',encoding='euc-jp') as original,open('passive-juman/dev/'+os.path.split(juman_path)[1],'w',encoding='utf-8') as new_juman:
